...
Cypress.Commands.add('writeArticleAndPostComments', article => {
  cy.window()
    .its('agent.Articles')
    .invoke('create', article)
    .its('article.slug')
    .then(slug => {
      cy.server();
      cy.route(`/api/articles/${slug}/comments`, {
        comments: [{
          id:1,
          createdAt: "2020-04-21T15:45:02.546Z",
          updatedAt: "2020-04-21T15:45:02.546Z",
          body: "great post!!",
          author: {
            id:1,
            username:"testuser",
            bio:"my stubbed bio",
            image:"https://github.com/hussainweb/hussainweb/blob/main/icons/dotnet.png",
            following: false
          }
        }]
    }).as('comments');
