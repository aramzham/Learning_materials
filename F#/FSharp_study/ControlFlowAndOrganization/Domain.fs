...
with static member New id transactionType amount = { Id = id; Type = transactionType; Amount = amount }
...
with static member New id balance transactions = { Id = id; Balance = balance; Transactions = transactions }
